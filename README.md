...
| **uTicket** | Automática, por produtor rastreado (`ORGANIZERS`, por slug, ou `ORGANIZER_IDS`, por userId direto quando o slug não lista o mesmo evento) + lista avulsa (`EVENTS`) | Site protegido por Cloudflare — usa navegador real (Playwright) |
